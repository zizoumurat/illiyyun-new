...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/videos/index.vue?vue&type=template&id=f16ba4b6&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container-fluid"},[_c('HorizontalVideoCard',{attrs:{"url":_vm.url}})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/videos/index.vue?vue&type=template&id=f16ba4b6&
...
//
//
/* harmony default export */ var videosvue_type_script_lang_js_ = ({async asyncData(context){let aranan=context.query.aranan;function cevir(aranan){return aranan.replace("Ğ","g").replace("Ü","u").replace("Ş","s").replace("I","i").replace("İ","i").replace("Ö","o").replace("Ç","c").replace("ğ","g").replace("ü","u").replace("ş","s").replace("ı","i").replace("ö","o").replace("ç","c");}aranan=await cevir(aranan);const url="query="+aranan;await context.store.dispatch("getVideosForHorizontalVidCard",url+"&per_page=12&page=1");return{url};},watch:{"$route.query.aranan":async function(){let aranan=this.$route.query.aranan;function cevir(aranan){return aranan.replace("Ğ","g").replace("Ü","u").replace("Ş","s").replace("I","i").replace("İ","i").replace("Ö","o").replace("Ç","c").replace("ğ","g").replace("ü","u").replace("ş","s").replace("ı","i").replace("ö","o").replace("ç","c");}aranan=await cevir(aranan);const url="query="+aranan;await this.$store.dispatch("getVideosForHorizontalVidCard",url+"&per_page=12&page=1");}}});
...
installComponents(component, {HorizontalVideoCard: __webpack_require__(63).default})
